...
import Common.exceptions.InvalidPathForExcelException;
...
//                sh = wb.createSheet(sheetName);
    ...
    public String getTCName(String sTestCaseName) {
        String testCaseName = null;
            for (int i = 0; i <= getRows(); i++) {
                if (getCellData(i, 0).equalsIgnoreCase(sTestCaseName)) {
                    Log.info("getRowUsed: " + getRows());
                    testCaseName = getCellData(i, 1);
                    break;
                }
            }
            return testCaseName;
    ...
    public String getTestCaseName(String testCaseName) {
        String value = testCaseName.substring(0, testCaseName.indexOf("@"));
